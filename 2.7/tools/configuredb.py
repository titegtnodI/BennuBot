...
funcPrefix = raw_input('\nWhat should be the function prefix be? ['+main.funcPrefix+']: ')
if funcPrefix != '': main.funcPrefix = funcPrefix
protoPrefix = raw_input('What should be the protocol prefix be? ['+main.protoPrefix+']: ')
...
quiet = raw_input('Should I supress most debugging output? (0/1) ['+str(main.quiet)+']: ')
if quiet != '': main.quiet = bool(quiet)
mainWait = raw_input('What should the mainloop wait be? ['+str(main.mainWait)+']: ')
