...
def time_tiem(inMSG):
	gmt,est,cst,pst,mst,art,syd,nz,cest,eet,hkt = [str(random.randrange(0,3)) + str(random.randrange(0,10)) + ":" + str(random.randrange(0,6)) + str(random.randrange(0,10)) for i in range(11)]
